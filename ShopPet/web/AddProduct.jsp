...
<!--                    action="DispatchServlet" class="body-table" method="post"   enctype="multipart/form-data" -->
                    <form class="body-table" method="post" >
                        ...
                        <label class="label">
                            <span>
                                <font color="red">
                                <%= request.getAttribute("ERROR_FILE") != null ? request.getAttribute("ERROR_FILE") : ""%>
                                </font>
                            </span>
                        </label>
                        <div id="name-text">
                            <span>Name</span>
                            <input type="text" name="txtName" value="" class="input" />
                        </div>
                        <div class="type">
                            <span>Type</span>
                            
                            <select id="select-type" name="txtType" class="input">
                        ...
                        <div class="size">
                            <span>Size</span>
                            <input type="text" name="txtSize" id="size" value="" class="input number" />
                        </div>
                        <div class="quantity">
                            <span>Quantity</span>
                            <input type="number" name="txtQuantity" min="1" value="" class="input number" />
                        </div>
                        <div class="category">
                            <span>Category</span>
                            <input type="text" name="txtCategory" value="" class="input" />
                        </div>
                        <div class="price">
                            <span>Price</span>
                            <input type="number"  name="txtPrice" value="" min="1" class="input number" />
                        </div>
                        <div class="button-add">
                            <input type="submit" id="btAdd"  name="btAction" value="Add"  />
                        </div>
