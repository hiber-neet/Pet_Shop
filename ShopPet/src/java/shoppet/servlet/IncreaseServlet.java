...
public class IncreaseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
                ...
                if(where != null && where.equals("PAYMENT")){
                    ...
                    if(session != null){
                        ...
                        for(String item : listProductsBuy.keySet()){
                            ...
                            int currQuantity = dao.getQuantity(idProduct);
                    ...
                    boolean  inscrease = dao.increaseQuantity(email, idProduct, quantity);
                    url = CART_PAGE;
                }
            ...
            Logger.getLogger(IncreaseServlet.class.getName()).log(Level.SEVERE, null, ex);
