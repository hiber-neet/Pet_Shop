 ...
 * @author nhutm
 */
public class DeleteInPaymentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(session != null){
                ...
                if(listProductsBuy != null && !listProductsBuy.isEmpty()){
                        if(listProductsBuy.size() == 1){
                            isEmpty = true;
                        }
                        if(listProductsBuy.containsKey(idProduct)) listProductsBuy.remove(idProduct);
                }
