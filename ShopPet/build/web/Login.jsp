<%-- 
    Document   : Login.jsp
    Created on : Mar 2, 2024, 9:39:53 PM
    Author     : nhutm
--%>
    ...
    <body>
        ...
        %>
         <form action="DispatchServlet" method="post">
                ...
                <input type="hidden" name="txtRole" value="false" />
                <input type="submit" name="btAction" value="Login" />
                <p>You don't have account ? <a href="./Register.jsp">Register</a></p>
                <p>Manager ? <a href="./LoginAdmin.jsp">Login to manager</a></p>
          </form>
    </body>
</html>
